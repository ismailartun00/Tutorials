package com.ismailartun.kotlinogrenmeprojesi
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialiazing, Initialization - Başlatma, Değerini Atama
        benimIntegerim = 10
        ...
        val stringOrnegi = "İsmail"

        var benimDizim = arrayOf(stringOrnegi, "Artun", "Zeynep", "Kerem", "Osman")
        ...
        val karisikDizi = arrayOf("İsmail", 24, 16.5, true, false)
