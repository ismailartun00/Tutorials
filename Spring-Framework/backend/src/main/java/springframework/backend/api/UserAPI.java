package springframework.backend.api;
...
import springframework.backend.shared.GenericResponse;

// sayfadan gelen bütün istekleri karşılayacak. handle edilmesini sağlayacak
 @RestController
//olan değişkenlere göre constructor oluştur, @Autorwired gibi çalışır.
