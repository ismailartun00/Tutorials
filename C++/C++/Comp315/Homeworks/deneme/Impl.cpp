...
template <class X>
Stack<X>::Stack(const std::initializer_list<X> elms) : totalSize(elms.size()){
...
//Copy Constructor
template <class X>
Stack<X>::Stack(const Stack<X>& other): currentSize(other.currentSize) ,totalSize(other.totalSize), arr(new X[totalSize]) {
